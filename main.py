...
# المفتاح بتنسيق "السطر الصريح" لمنع خطأ PEM و Syntax
...
st.set_page_config(page_title="أرشيف المحطة")
...
if st.sidebar.text_input("الرمز:", type="password") == "123":
    ...
    try:
        ...
        st.success(f"✅ متصل بـ: {folder['name']}")
        
        f = st.file_uploader("اختر صورة الوصل:")
    ...
    st.info("أدخل 123 في القائمة الجانبية")
