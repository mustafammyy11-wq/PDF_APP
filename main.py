...
# 1. بيانات الحساب (مكتوبة بتنسيق الأسطر لضمان النجاح)
...
nr/9qFz/VtQKBgQC8m7ul6jx7DxmwDuTqOh2TEGSIOLE920Ha15M5amIScPPXdxvw
...
if st.sidebar.text_input("الرمز:", type="password") == "123":
    ...
    try:
        ...
        if up_file and st.button("رفع الملف الآن"):
