...
# 1. إعدادات المجلد (ID المجلد الذي شاركته)
...
# 2. المفتاح الخاص (وضعناه بطريقة تمنع خطأ \N نهائياً)
PK = (
    "-----BEGIN PRIVATE KEY-----\n"
...
# 3. إعداد تطبيق Streamlit
st.set_page_config(page_title="أرشيف PDF")
